...
if (isset($_SESSION['sucesso_cadastro'])) {
    ...
    unset($_SESSION['sucesso_cadastro']); // Limpa a sessão
}

if (isset($_SESSION['erros_cadastro'])) {
    $erros = $_SESSION['erros_cadastro'];
    unset($_SESSION['erros_cadastro']); // Limpa a sessão
}
    ...
    if (empty($erros)) {
        ...
        $sql_insert = "INSERT INTO usuarios 
                        (email, senha, titulo, nome, sobrenome, telefone, 
                         local_residencia, data_nascimento, aceita_comunicacoes, data_registro) 
                       VALUES 
                        (?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
        ...
        <?php if (empty($mensagem_sucesso)): ?>
            ...
            <form action="cadastro.php" method="POST" class="form-cadastro">
                ...
                <div class="form-grupo-minimalista">
                    ...
                    <input type="text" id="local_residencia" name="local_residencia">
                </div>
                
                <div class="form-grupo-minimalista">
                    <label for="data_nascimento">Data de nascimento (opcional)</label>
                    <input type="text" id="data_nascimento" name="data_nascimento" placeholder="AAAA-MM-DD (ex: 1990-05-30)">
                </div>

                <div class="form-grupo-checkbox">
                    <input type="checkbox" id="aceita_comunicacoes" name="aceita_comunicacoes" value="1">
